import { CreditCard, KeyRound, Layers3, LogOut, RadioTower, ReceiptText, Router, Users, Wifi } from 'lucide-react'
    ...
    <main className="app-shell">
      <header className="topbar">
        ...
        <nav className="main-nav" aria-label="Navegacion principal">
          ...
          <NavLink to="/recibos"><ReceiptText size={17} /> Recibos</NavLink>
